...
import com.exmple.corelib.utils.MPhotoUtils
import com.exmple.corelib.utils.hasSdcard
import com.exmple.corelib.utils.showToastCenter
 ...
 */
abstract class MBaseMvpPhotoActivity<V : ITopView, P : ITopPresenter> : MBaseMvpTitleActivity<V, P>() {
    ...
    fun openGallery() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            MPhotoUtils.openPic(this, GALLERY_REQUEST_CODE)
        }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == CAMERA_REQUEST_CODE) {
                imageUri?.let {
                    val bitmapFromUri = MPhotoUtils.getBitmapFromUri(it, this)
                ...
                if (hasSdcard()) {
                    ...
                    val bitmapFromUri = MPhotoUtils.getBitmapFromUri(newUri, this)
